          ...
          return (
            <li key={s.id} className="group relative">
              <button
                ...
                className={`flex w-full flex-col rounded-xl px-3 py-2 pr-8 text-left transition-colors ${
                  isActive
              ...
              <button
                ...
                className="absolute right-1.5 top-1/2 -translate-y-1/2 rounded-lg p-1.5 text-slate-400 opacity-0 transition-opacity hover:bg-slate-200 hover:text-rose-600 focus-visible:opacity-100 group-hover:opacity-100 dark:hover:bg-slate-700 dark:hover:text-rose-400"
              >
                <svg viewBox="0 0 16 16" fill="none" className="h-3.5 w-3.5" aria-hidden>
                  <path
